...
public class Menu {
    ...
    public void showFilmTable(List<Film> entityList) {
        System.out.println("Listing list of Films \n");
        for (Film f : entityList) {
            System.out.println(f.toString());
        }
        System.out.println(
                String.format("%d Films found\n", entityList.size())
        );
    }
    ...
    public Actor inputActor() {
        ...
        try {
            ...
            showMessage("year can not be String \n");
            actor = null;
        }
        return actor;
    }
    ...
    public Film inputFilm() {
        ...
        try {
            ...
            int year = this.inputInt("Input year: ");
            film = new Film(title, director, description, year);
        } catch (InputMismatchException | NumberFormatException inp) {
            showMessage("year can not be String \n");
            film = null;
        }
        return film;
